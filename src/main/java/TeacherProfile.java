...
//      newTeacher.setName(teacher.get("name"));
//      newTeacher.setFavoriteLanguage(teacher.get("favorite_language"));
//      newTeacher.setYearsExperience(Integer.parseInt(teacher.get("years_experience")));
...
//    System.out.println(nick.getFavoriteLanguage());
//    System.out.println(nick.getName());
//    System.out.println(nick.getYearsExperience());
//  }
}
